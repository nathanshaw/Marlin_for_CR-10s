...
#define STRING_CONFIG_H_AUTHOR "(NVS Tech, ALS)" // Who made the changes.
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    12        // LED driving pin on motherboard 4 => D4 (EXP2-5 on Printrboard) / 30 => PC7 (EXP3-13 on Rumba)
