...
#define BED_CHECK_INTERVAL 15000 // ms between checks in bang-bang control
#if ENABLED(BED_LIMIT_SWITCHING)
#define BED_HYSTERESIS 7 // Only disable heating if T>target+BED_HYSTERESIS and enable heating if T>target-BED_HYSTERESIS
#endif
#endif
...
#define THERMAL_PROTECTION_BED_PERIOD 220    // Seconds
...
//#define CONTROLLER_FAN_PIN FAN1_PIN  // Set a custom pinHYSTERESIS for the controller fan
